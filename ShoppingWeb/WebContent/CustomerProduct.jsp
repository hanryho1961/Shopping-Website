...
<body>
	...
	<div class="menu">
		<form action="CustomerPageServlet?task=home&customername=<%=request.getParameter("customername") %>" method="post">
		...
		<form action="CustomerPageServlet?task=cart&customername=<%=request.getParameter("customername") %>" method="post">
		...
		<form action="CustomerPageServlet?task=details&customername=<%=session.getAttribute("customername") %>" method="post">
			<input type="submit" value="<%=request.getParameter("customername") %>" id="loginButton">
		</form>
	</div>
	<div class="shade">
	</div>
					...
					<c:if test="${ row < 4}">
						<td>
							...
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 10px; width: 100px; height: 30px">
								<form action="CustomerPageServlet?task=payNow&customername=<%=request.getParameter("customername") %>&total=${sanPham.gia }&masp=${sanPham.masp }" method="post">
									<input type="submit" value="Buy Now" id="buyNow">
								</form>
							</div>
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 13px; width: 100px; height: 30px">
								<form action="CustomerPageServlet?task=addCart&masp=${sanPham.masp }&customername=<%=request.getParameter("customername") %>" method="post">
									<input type="submit" value="Add to Cart" id="addCart">
								</form>
							</div>
						</td>
