...
<body>
	...
	<div class="introduction">
		<div class="category">
			...
			<div class="categoryMenu">
				...
				%>
					<a href="HomePageProduct.jsp?madm=<%=danhMuc.getMadm() %>" style="font-size: 20px; text-decoration: none; margin-left: 10px"><%=danhMuc.getTendm() %></a>
					<br>
				<% } %>
			</div>
			...
			<div class="product">
					...
					<div class="workInfo">
						...
						<div class="workAction">
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 15px; width: 100px; height: 30px">
								<form action="HomePageServlet?task=buyNow" method="post">
							...
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 13px; width: 100px; height: 30px">
								<form action="HomePageServlet?task=addCart" method="post">
				...
				<div class="game">
					...
					<div class="workInfo">
						...
						<div class="workAction">
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 15px; width: 100px; height: 30px">
								<form action="HomePageServlet?task=buyNow&masp=${sanPham.masp }" method="post">
									<input type="submit" value="Buy Now" id="buyNow">
								</form>
							</div>
							<div style="border: 0px solid black; float: left; margin-top: 15px; margin-left: 13px; width: 100px; height: 30px">
								<form action="HomePageServlet?task=addCart&masp=${sanPham.masp }" method="post">
									<input type="submit" value="Add to Cart" id="addCart">
								</form>
							</div>
						</div>
	...
	<div class="body">
		...
		<% ArrayList<SanPham> list =  (new SanPhamModel()).getList(request.getParameter("madm")); %>
